                ...
                <div class="col-lg-4 col-md-5 d-flex align-items-stretch">
                  <div class="info-wrap bg-fls w-100 p-md-5 p-4">
                    ...
                    <div class="dbox w-100 d-flex align-items-center">
                      ...
                      <div class="text pl-3">
                        <p><span>Telefon:</span> <a href="tel://1234567920">(0263) 111 123</a></p>
                      </div>
                    </div>
                    <div class="dbox w-100 d-flex align-items-center">
                      <div class="icon d-flex align-items-center justify-content-center">
                      ...
                      <div class="text pl-3">
                        <p><span>Email:</span> <a href="mailto:info@yoursite.com">info@zoolove.com</a></p>
                      </div>
                    </div>
                    <div class="dbox w-100 d-flex align-items-center">
                      <div class="icon d-flex align-items-center justify-content-center">
                      ...
                      <div class="text pl-3">
                        <p><span>Website</span> <a href="#"> zoolove </a></p>
                      </div>
                    </div>
                  </div>
                </div>
