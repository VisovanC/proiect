...
<div class="container mt-5">
    <div class="row justify-content-center my-2">
        <div class="col-auto d-flex flex-row"><i class="fa-solid fa-user p-1"></i><h4 class="px-3">LOGIN</h4></div>
    </div>
    <div class="row justify-content-center my-2">
      <div class="col-7">
        ...
        <div class="form-group row">
          <label for="username" class="col-sm-2 col-form-label">Utilizator</label>
            <div class="col-sm-10">
